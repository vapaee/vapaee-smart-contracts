        ...
        namespace deposit {
            ...
            void aux_add_deposits(name owner, const asset & amount, name ram_payer) {
                ...
                if (has_auth(vapaee::book::contract)) {
                    PRINT(" -> contract has auth : ", vapaee::book::contract.to_string(), "\n");
                ...
                depusers depuserstable(vapaee::book::contract, vapaee::book::contract.value);
                ...
                if (user_itr == depuserstable.end()) {
                    ...
                    if (ram_payer != vapaee::book::contract) {
            ...
            void aux_swapdeposit(name from, name to, const asset & quantity, string memo) {
                ...
                if (has_auth(to)) {
                    ...
                    ram_payer = vapaee::book::contract;
                }
                PRINT("   -> ram_payer: ", ram_payer.to_string(), "\n");
            ...
            void aux_transfer_earnings_to_client(const uint64_t ui, const asset & quantity) {
                ...
                action(
                    ...
                    tk_ptr->contract,
                    name("transfer"),
                    std::make_tuple(vapaee::book::contract, receiver, amount, memo)
                ).send();
            ...
            void handle_book_transfer(name from, name to, asset quantity, string memo, name tokencontract) {
                ...
                name ram_payer = vapaee::book::contract;
