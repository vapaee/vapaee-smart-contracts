...
namespace vapaee {
    namespace utils {      
        ...
        inline string create_error_string4(const char * text, const string str1, const string str2, const string str3, const string str4) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + str1 + ", " + str2 + ", " + str3 + ", " + str4 + "]";
        }

        inline string create_error_id1(const char * text, const uint64_t id) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + std::to_string((unsigned long) id ) + "]";
        }

        inline string create_error_id2(const char * text, const uint64_t id1, const uint64_t id2) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + std::to_string((unsigned long) id1 ) + ", " + std::to_string((unsigned long) id2 ) + "]";
        }

        inline string create_error_id3(const char * text, const uint64_t id1, const uint64_t id2, const uint64_t id3) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + std::to_string((unsigned long) id1 ) + ", " + std::to_string((unsigned long) id2 ) + ", " + std::to_string((unsigned long) id3 ) + "]";
        }

        inline string create_error_double1(const char * text, const double value) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + std::to_string( value ) + "]";
        }

        inline string create_error_double2(const char * text, const double value1, const double value2) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + std::to_string( value1 ) + ", " + std::to_string( value2 ) + "]";
        }

        inline string create_error_double3(const char * text, const double value1, const double value2, const double value3) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + std::to_string( value1 ) + ", " + std::to_string( value2 ) + ", " + std::to_string( value3 ) + "]";
        }
        ...
        inline string create_error_symcode1(const char * text, const symbol_code & sym1) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + sym1.to_string() + "]";
        }

        inline string create_error_symcode2(const char * text, const symbol_code & sym1, const symbol_code & sym2) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + sym1.to_string() + "], [" + sym2.to_string()+"]";
        }

        inline string create_error_symbol1(const char * text, const symbol & sym1) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + sym1.code().to_string() + "]";
        }

        inline string create_error_symbol2(const char * text, const symbol & sym1, const symbol & sym2) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + sym1.code().to_string() + "], [" + sym2.code().to_string()+"]";
        }

        inline string create_error_name1(const char * text, const name & account1) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + account1.to_string() + "]";
        }

        inline string create_error_name2(const char * text, const name & account1, const name & account2) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + account1.to_string() + "," + account2.to_string() + "]";
        }

        inline string create_error_asset1(const char * text, const asset & token1) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + token1.to_string() + "]";
        }

        inline string create_error_asset2(const char * text, const asset & token1, const asset & token) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + token1.to_string() + "], [" + token.to_string()+"]";
        }

        inline string create_error_asset3(const char * text, const asset & token1, const asset & token, const asset & token3) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + token1.to_string() + "], [" + token.to_string()+"], [" + token3.to_string()+"]";
        }
        ...
        inline string create_error_asset4(const char * text, const asset & token1, const asset & token, const asset & token3, const asset & token4) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + token1.to_string() + "], [" + token.to_string()+"], [" + token3.to_string()+"], [" + token4.to_string()+"]";
        }
        ...
        inline string create_error_asset5(const char * text, const asset & token1, const asset & token, const asset & token3, const asset & token4, const asset & token5) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + token1.to_string() + "], [" + token.to_string()+"], [" + token3.to_string()+"], [" + token4.to_string()+"], [" + token5.to_string()+"]";
        }
        ...
        inline string create_error_bool4(const char * text, const bool value1, const bool value2, const bool value3, const bool value4) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + std::to_string(value1) + "], [" + std::to_string(value2) + "], [" + std::to_string(value3) + "], [" + std::to_string(value4) + "]";
        }
        ...
        inline string create_error_time1(const char * text, const time_point_sec value1) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + time_point_sec_to_string(value1) + "]";
        }

        inline string create_error_time2(const char * text, const time_point_sec value1, const time_point_sec value2) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + time_point_sec_to_string(value1) + "], [" + time_point_sec_to_string(value2) + "]";
        }
        ...
        inline string create_error_time3(const char * text, const time_point_sec value1, const time_point_sec value2, const time_point_sec value3) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + time_point_sec_to_string(value1) + "], [" + time_point_sec_to_string(value2) + "], [" + time_point_sec_to_string(value3) + "]";
        }
        ...
        inline string create_error_time4(const char * text, const time_point_sec value1, const time_point_sec value2, const time_point_sec value3, const time_point_sec value4) {
            return vapaee::current_contract.to_string() + "::" + string(text) + " [" + time_point_sec_to_string(value1) + "], [" + time_point_sec_to_string(value2) + "], [" + time_point_sec_to_string(value3) + "], [" + time_point_sec_to_string(value4) + "]";
        }
